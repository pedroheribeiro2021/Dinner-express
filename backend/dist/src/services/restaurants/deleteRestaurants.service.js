...
exports.deleteRestaurantService = void 0;
const data_source_1 = require("../../data-source");
const restaurants_entity_1 = require("../../entities/restaurants.entity");
const deleteRestaurantService = (restaurantId) => __awaiter(void 0, void 0, void 0, function* () {
    const restaurantRepository = data_source_1.AppDataSource.getRepository(restaurants_entity_1.Restaurant);
    const restaurant = yield restaurantRepository.findOneBy({
        id: restaurantId
    });
    yield restaurantRepository.remove(restaurant);
});
